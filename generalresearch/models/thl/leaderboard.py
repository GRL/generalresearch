...
class Leaderboard(BaseModel):
    ...
    # Note: id and name get auto-generated by the model_validators, but the fields need
    #   to be optional with a default or the model can't be inited.
    # todo: these should really be computed_fields instead
